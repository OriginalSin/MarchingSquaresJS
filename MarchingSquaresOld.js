...
(function (window){
    ...
    // the boundary.
    MarchingSquaresOld.getBlobOutlinePoints = function(sourceCanvas, startingPoint){
        ...
        if (!startingPoint) {
			startingPoint = MarchingSquaresOld.getFirstNonTransparentPixelTopDown(MarchingSquaresOld.sourceCanvas);
		}
